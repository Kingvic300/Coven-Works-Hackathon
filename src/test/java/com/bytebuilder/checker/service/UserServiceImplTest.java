...
import com.bytebuilder.checker.dto.response.CreatedUserResponse;
import com.bytebuilder.checker.dto.response.LoginResponse;
import com.bytebuilder.checker.dto.response.OTPResponse;
import com.bytebuilder.checker.dto.response.ResetPasswordResponse;
import com.bytebuilder.checker.exception.AlreadyExistsException;
import com.bytebuilder.checker.exception.InvalidOtpException;
...
class UserServiceImplTest {
    ...
    void handleGoogleLogin_ShouldThrowExceptionWhenUserExistsButNotGoogleUser() {
        ...
        IllegalStateException exception = assertThrows(
                ...
                () -> userService.handleGoogleLogin(validEmail, validName, "USER")
        );
    ...
    void handleGoogleLogin_ShouldLoginSuccessfullyWhenUserExistsAndIsGoogleUser() {
        ...
        LoginResponse result = userService.handleGoogleLogin(validEmail, validName, "USER");
